<?php
namespace HR\Bundle\UserBundle\Tests\Model;
...
{
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|\HR\Bundle\UserBundle\ModelManager\UserManager
     */
    private $manager;
    ...
    protected function setUp()
    {
        ...
        $this->manager = $this->getMockBuilder('HR\Bundle\UserBundle\ModelManager\UserManager')
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\HR\Bundle\UserBundle\Model\User
     */
    private function getUser()
    {
        return $this->getMockBuilder('HR\Bundle\UserBundle\Model\User')->getMockForAbstractClass();
    }
}